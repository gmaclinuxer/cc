...
$(function(){
    ...
    /*$('#help-btn').click(function(e){
     $('.video-content').before($('.video-content').clone().removeClass('none'));
     });
    ...
    $('#help-btn').click(function(e){
        $('.video-content').removeClass('none');
    });

    $('#video-close').click(function(e){
        $('.video-content').addClass('none');
    ...
    $('#help-btn1').click(function(e){
        $('.video-content1').removeClass('none');
    });

    $('#video-close1').click(function(e){
        $('.video-content1').addClass('none');
    ...
    $('#help-btn2').click(function(e){
        $('.video-content2').removeClass('none');
    });

    $('#video-close2').click(function(e){
        $('.video-content2').addClass('none');
        var myPlayer = videojs('video2');
    ...
    $('#help-btn3').click(function(e){
        $('.video-content3').removeClass('none');
    });

    $('#video-close3').click(function(e){
        $('.video-content3').addClass('none');
        var myPlayer = videojs('video3');
